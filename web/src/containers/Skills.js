      ...
      <div className="px-6">
        ...
        <div className="mt-2 py-10 border-t border-gray-300 text-center">
          <div className="flex flex-wrap justify-center">
            <div className="justify-center flex flex-1 mb-4 w-full lg:w-9/12 px-4 text-gray-800 flex-wrap">
              <Skill logo="fab fa-html5 fa-9x" title="HTML5"></Skill>
              <Skill logo="fab fa-css3 fa-9x" title="CSS3"></Skill>
        ...
        <div className="mt-2 py-10 border-t border-gray-300 text-center">
          <div className="flex flex-wrap justify-center">
            <div className="justify-center flex flex-1 mb-4 w-full lg:w-9/12 px-4 text-gray-800 flex-wrap">
              ...
              <Skill logo="fas fa-database fa-9x" title="SQL"></Skill>
              <Skill logo="far fa-copy fa-9x" title="NoSQL"></Skill>
            </div>
          </div>
        </div>
        <div className="text-sm leading-normal mt-4 mb-2 text-gray-500 font-bold uppercase">
        ...
        <div className="mt-2 py-10 border-t border-gray-300 text-center">
          <div className="flex flex-wrap justify-center">
            <div className="justify-center flex flex-1 mb-4 w-full lg:w-9/12 px-4 text-gray-800 flex-wrap">
              ...
              <Skill logo="fab fa-linux fa-9x" title="Linux"></Skill>
