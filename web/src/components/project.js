...
const Project = ({ img, title, skillsList, description, link }) => {
  return (
    <a href={link}>
      <div className="p-10 m-2 bg-gray-50 shadow-xl rounded-2xl md:w-96">
        ...
        <div className="text-center text-sm leading-normal my-8 text-gray-800  ">
          {description}
        </div>
      </div>
    </a>
